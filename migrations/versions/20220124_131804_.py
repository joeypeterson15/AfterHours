...
Revision ID: ba197f6f5c32
Revises: 
Create Date: 2022-01-24 13:18:04.240550
...
def upgrade():
    ...
    sa.Column('friendName', sa.String(length=50), nullable=False),
    sa.Column('friendAvatar', sa.String(length=500), nullable=False),
    ...
    sa.ForeignKeyConstraint(['dm_server_Id'], ['dmchannels.id'], ),
